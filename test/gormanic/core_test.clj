...
(deftest output-tests
  ...
  (testing "non leap year"
    ...
    (is (= "Intermission 2015" (convert (t/date-time 2015 12 31))))
    (is (= "Intermission 2015" (convert (t/date-time 2015 12 31)))))
  (testing "post leap year")
  (is (= "4 May 2016" (convert (t/date-time 2016 2 29))))  
  (is (= "2 February 2016" (convert (t/date-time 2016 11 5))))  
  (is (= "8 June 2016" (convert (t/date-time 2016 4 1))))  
  (is (= "Intermission 2016" (convert (t/date-time 2016 12 30))))  
  (is (= "Intermission 2016" (convert (t/date-time 2016 12 31)))))